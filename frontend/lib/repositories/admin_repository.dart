...
//       final transactions = (result['transactions'] as List).map((e) => BalanceTransaction.fromJson(e)).toList();
//       return transactions;
//     } catch (e) {
...
//   Future<(List<dynamic>?, List<dynamic>?)> getCategoriesStatsData() async {
//     try {
//       final result = await ApiBaseHelper().request(RequestType.get, '/admin/categories-stats-data', sendToken: true);
//       final subscription = (result?['subscription'] as List);
