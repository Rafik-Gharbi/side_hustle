                    ...
                    ...List.generate(
                      ...
                      (index) => SizedBox(
                        ...
                        child: ListTile(
                          ...
                          minLeadingWidth: 10,
                          leading: Text('${index + 1}', style: AppFonts.x12Regular),
                          title: LinearProgressIndicator(value: Helper.getRatingPercentage(reviews, index + 1), backgroundColor: kNeutralColor.withOpacity(0.4)),
                        ),
                      ),
                    ),
