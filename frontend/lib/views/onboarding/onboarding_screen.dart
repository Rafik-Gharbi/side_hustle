  ...
  Widget build(BuildContext context) {
    ...
    return HoldInSafeArea(
      child: StatefulBuilder(
        builder: (context, setState) => Obx(() => IntroductionScreen(
              pages: [
                PageViewModel(
                  title: 'welcome_to'.tr,
                  bodyWidget: Column(
                ...
                PageViewModel(
                  ...
                  bodyWidget: Padding(
                    ...
                    child: FutureBuilder<File?>(
                      future: isTerms ? ParamsRepository.find.getTermsCondition() : ParamsRepository.find.getPrivacyPolicy(),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          return SizedBox(
                            ...
                            child: Column(
                              children: [
                                Expanded(child: SfPdfViewer.file(snapshot.data!, pageSpacing: 1)),
                                  ...
                                  title: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        ...
                                        const TextSpan(text: ' and ', style: AppFonts.x14Regular),
                                        TextSpan(
                                          text: 'Privacy Policy',
                                          style: AppFonts.x14Regular.copyWith(color: kPrimaryColor),
