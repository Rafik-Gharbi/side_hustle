    ...
    return GetBuilder<AddTaskController>(
      ...
      initState: (state) {
        Helper.waitAndExecute(() => state.controller != null, () {
          if (!hasFinishedAddTaskTutorial && !hasOpenedTutorial && state.controller!.targets.isNotEmpty) {
                          ...
                          title: RichText(
                            text: TextSpan(
                              children: [
                                ...
                                WidgetSpan(
                                  child: InkWell(
                                    onTap: () => Helper.openDatePicker(currentTime: controller.createdDate, onConfirm: (date) => controller.createdDate = date, isFutureDate: true),
                                    child: Text(
