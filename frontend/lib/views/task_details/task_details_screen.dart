            ...
            child: Column(
              ...
              children: [
                ...
                CustomButtons.elevatePrimary(
                  ...
                  onPressed: () => AuthenticationService.find.isUserLoggedIn.value ? {} : Helper.snackBar(message: 'login_express_interest_msg'.tr),
                  width: Get.width,
                ),
                const SizedBox(height: Paddings.small),
                Align(alignment: Alignment.centerRight, child: Text('7 ${'expressed_interest'.tr}', style: AppFonts.x12Regular.copyWith(color: kNeutralColor))),
                const SizedBox(height: Paddings.exceptional),
              ],
            ),
          ),
