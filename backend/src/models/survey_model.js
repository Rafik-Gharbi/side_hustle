...
const Survey = sequelize.define(
  "survey",
  {
    ...
    cityFrom: { type: Sequelize.STRING, allowNull: false },
    ...
    annualMarketing: { type: Sequelize.STRING, allowNull: false },
    currentlyDelegating: { type: Sequelize.STRING, allowNull: false },
    ...
    currentlyDelegatingWith: { type: Sequelize.STRING, defaultValue: "" },
